...
router.get("/stock", passport.checkAuthentication, common_function.checkPermission("stockView"), stockController.stockViewPage);
router.get("/stock/add", passport.checkAuthentication, common_function.checkPermission("stockAdd"), stockController.stockAddPage);
router.get("/stock/edit", passport.checkAuthentication, common_function.checkPermission("stockEdit"), stockController.stockEditPage);
router.get("/stock/edit-image", passport.checkAuthentication, common_function.checkPermission("stockImageEdit"), stockController.stockImageEditPage);
