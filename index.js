...
app.use(express.json({
    type: (req) => req.headers['content-type'] && req.headers['content-type'].includes('json')
}));
...
app.use(env.asset_path, express.static(path.join(__dirname, env.asset_path.substring(1))));
