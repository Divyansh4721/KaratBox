/*
    this is a dummy old copy of estimate Retail in which first table 
    was created to image and then resized according to the page while printing
    latest android was updates were having issues therefore changed it
*/
